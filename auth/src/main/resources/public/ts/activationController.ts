import { ng, idiom as lang, http, template } from 'entcore/entcore';

export let activationController = ng.controller('ActivationController', ['$scope', function($scope){
...
export let cguController = ng.controller('CGUController', ['$scope', 'template', function($scope, template){
	$scope.template = template;
